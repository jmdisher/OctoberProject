...
public class CuboidTranslator
{
	...
	private static void _remapBlockChanges(Environment env, CuboidData cuboid)
	{
		...
		short waterStrong = env.items.getItemById("DEPRECATED.op.water_strong").number();
		...
		for (BlockAddress clear : clearLocations)
		{
			cuboid.setData15(AspectRegistry.BLOCK, clear, (short)0);
		}
	}
