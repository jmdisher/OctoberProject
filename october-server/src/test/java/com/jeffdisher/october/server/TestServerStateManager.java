...
public class TestServerStateManager
{
	...
	public void connectClient()
	{
		...
		callouts.loadedCuboids.add(new SuspendedCuboid<CuboidData>(CuboidGenerator.createFilledCuboid(callouts.requestedCuboidAddresses.iterator().next(), ENV.blocks.AIR), List.of()));
		changes = manager.setupNextTickAfterCompletion(snapshot);
