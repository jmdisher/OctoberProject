...
public class EntityActionValidator
{
	...
	public static Entity moveEntity(Function<AbsoluteLocation, Short> blockTypeReader, Entity entity, EntityLocation newLocation, int ticksToMove)
	{
		...
		return (null != path)
				? new Entity(entity.id(), newLocation, entity.zVelocityPerSecond(), entity.volume(), entity.blocksPerTickSpeed(), entity.inventory(), entity.selectedItem(), entity.localCraftOperation())
				: null
		;
	}
}
