...
public class FoodRegistry
{
	...
	{
		FlatTabListCallbacks<Item, Integer> callbacks = new FlatTabListCallbacks<>(new FlatTabListCallbacks.ItemTransformer(items), new FlatTabListCallbacks.IntegerTransformer("food_value"));
