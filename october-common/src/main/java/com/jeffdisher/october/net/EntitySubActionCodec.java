...
public class EntitySubActionCodec
{
	...
	static
	{
		...
		_CODEC_TABLE[EntitySubActionType.UNUSED_BLOCK_PLACE.ordinal()] = (DeserializationContext context) -> { throw Assert.unreachable(); };
		...
		_CODEC_TABLE[EntitySubActionPlaceSelectedBlockGeneric.TYPE.ordinal()] = (DeserializationContext context) -> EntitySubActionPlaceSelectedBlockGeneric.deserializeFromContext(context);
