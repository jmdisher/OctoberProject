...
public class TestCowStateMachine
{
	...
	{
		CowStateMachine machine = new CowStateMachine(null);
	...
	public void sendImpregnate()
	{
		...
		CowStateMachine fatherMachine = new CowStateMachine(CowStateMachine.encodeExtendedData(new CowStateMachine.Test_ExtendedData(true, null)));
		...
		CowStateMachine motherMachine = new CowStateMachine(CowStateMachine.encodeExtendedData(new CowStateMachine.Test_ExtendedData(true, null)));
	...
	public void becomePregnant()
	{
		...
		CowStateMachine machine = new CowStateMachine(extendedData);
