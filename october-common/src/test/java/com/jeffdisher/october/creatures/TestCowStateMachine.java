...
public class TestCowStateMachine
{
	...
	public void sendImpregnate()
	{
		...
		boolean didTakeAction = fatherMachine.doneSpecialActions(context, null, father.location(), father.type(), father.id(), mother.id());
		...
		didTakeAction = motherMachine.doneSpecialActions(context, null, mother.location(), mother.type(), mother.id(), father.id());
